...
export default function LeagueTableTab({ initialStandings = [], initialTeams = [], leagueSlug = 'premier-league' }: { initialStandings?: any[]; initialTeams?: any[]; leagueSlug?: string }) {
