      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-zinc-900 via-zinc-900 to-black p-6 md:p-8 group">
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div className="flex items-start gap-5">
            ...
            <div className="space-y-1">
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                <Badge
                  variant="outline"
                  className="bg-green-500/10 text-green-400 border-green-500/20 px-2 py-0.5 text-xs uppercase tracking-wide flex items-center gap-1.5"
                >
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <Button
              variant="outline"
              className="flex-1 md:flex-none rounded-full bg-transparent border-zinc-700 hover:bg-white/5 text-zinc-300 transition-all"
            >
              Stats
