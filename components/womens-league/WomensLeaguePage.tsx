// components/womens-league/WomensLeaguePage.tsx
"use client";
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-4">
            Error loading Women's League data
          </h2>
...
export default function WomensLeaguePage({ leagueId }: { leagueId: string }) {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
    ...
    >
      <WomensLeaguePageContent leagueId={leagueId} />
    </Suspense>
  );
}