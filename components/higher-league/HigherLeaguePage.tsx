// components/higher-league/HigherLeaguePage.tsx
"use client";
...
interface HigherLeaguePageProps {
  leagueId: string;
}
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-4">
            Error loading Higher League data
          </h2>
  ...
  if (!league) {
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-4">
            Higher League Not Found
          </h2>
          <p className="text-zinc-400 mb-6">
            The Higher League data is currently unavailable.
          </p>
...
export default function HigherLeaguePage({ leagueId }: HigherLeaguePageProps) {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
    ...
    >
      <HigherLeaguePageContent leagueId={leagueId} />
    </Suspense>
  );
}
