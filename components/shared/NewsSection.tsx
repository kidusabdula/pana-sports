...
const newsData: NewsItem[] = [
  {
    id: 1,
    title:
      "Saint George Extends Lead at Top with Convincing Victory Over Fasil",
    category: "Match Report",
    image:
      "https://www.soccerethiopia.net/wp-content/uploads/2025/11/IMG_20251125_201641_512-690x460.jpg", // Replace with real image
    date: "2h ago",
    author: "Samuel Tesfaye",
    excerpt:
      "The Horsemen dominated proceedings at Addis Ababa Stadium with goals from Getaneh and Shimeles...",
    content: `
  ...
  },
  {
    ...
    image:
      "https://www.soccerethiopia.net/wp-content/uploads/2025/11/IMG_20251125_212009_499-690x460.jpg", // Replace with real image
    date: "4h ago",
    author: "Mekonnen Bekele",
    excerpt:
      "Coach Wubetu Abate has named a 28-man squad for the upcoming Africa Cup of Nations qualifiers against Kenya and Tanzania...",
    content: `
  ...
  },
  {
    ...
    category: "Transfer",
    image:
      "https://www.soccerethiopia.net/wp-content/uploads/2025/11/IMG_20251125_212004_058-1-690x460.jpg", // Replace with real image
    date: "6h ago",
    author: "Dawit Alemu",
    excerpt:
      "The northern giants have completed the signing of Bahir Dar Kenema's creative midfielder in a record-breaking deal...",
    content: `
  ...
  },
  {
    ...
    category: "Exclusive",
    image:
      "https://www.soccerethiopia.net/wp-content/uploads/2025/11/IMG_20251125_201644_361.jpg", // Replace with real image
    date: "1d ago",
    author: "Tigist Haile",
    excerpt:
      "The Ethiopian Football Federation is considering the introduction of Video Assistant Referee (VAR) technology in the Premier League next season...",
    content: `
  ...
  },
  {
    ...
    category: "Club News",
    image:
      "https://www.soccerethiopia.net/wp-content/uploads/2025/11/IMG_20251125_201641_094-690x460.jpg", // Replace with real image
    date: "2d ago",
    author: "Kassahun Wondimu",
    excerpt:
      "The coach of Wolaitta Dicha has stepped down following a string of poor results that left the club hovering above the relegation zone...",
    content: `
  ...
  },
  {
    ...
    author: "Sofia Teklu",
    excerpt:
      "The Ethiopian Premier League has signed a three-year sponsorship deal with a major telecommunications company worth millions...",
    content: `
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-auto">
        {/* Hero Card (Major News) - Larger and More Prominent */}
        <div
          className="lg:col-span-8 group relative rounded-3xl overflow-hidden cursor-pointer h-[400px] md:h-[500px] lg:h-[600px] shadow-2xl"
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 p-6 md:p-10 lg:p-12 w-full">
            <div className="flex items-center gap-3 mb-4">
              <Badge className="bg-primary hover:bg-primary text-white border-none text-sm px-3 py-1 shadow-lg">
                {featuredNews.category}
              </Badge>
              <span className="text-sm text-zinc-200 flex items-center gap-1.5">
                <Clock className="w-4 h-4" /> {featuredNews.date}
              </span>
            </div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-3 md:mb-4 group-hover:text-primary transition-colors drop-shadow-lg">
              {featuredNews.title}
            </h1>
            <p className="text-base md:text-lg text-zinc-200 hidden md:block max-w-2xl leading-relaxed">
              ...
              {sideNews.map((news, i) => (
                ...
                >
                  ...
                  <div>
                    <Badge
                      variant="outline"
                      className="mb-1 text-[10px] py-0 px-1.5 border-zinc-700 text-zinc-400"
                    >
                      {news.category}
                    </Badge>
