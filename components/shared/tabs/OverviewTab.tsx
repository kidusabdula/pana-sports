    ...
    return (
      <Link href={`/matches/${match.id}`} className="block group">
        <div className="flex flex-col border-b border-white/5 last:border-0">
          <div className="flex items-center gap-2 md:gap-3 px-3 py-2.5 hover:bg-white/5 transition-colors">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
              ...
              <div className="w-6 h-6 rounded-full overflow-hidden border border-zinc-700/50 shrink-0 bg-zinc-800/50 flex items-center justify-center">
                <Image
        ...
        <div className="space-y-4">
          ...
          {liveMatches.length > 0 && (
            <Card className="bg-zinc-900/40 backdrop-blur-xl border-red-500/20 overflow-hidden">
              <CardHeader className="py-2.5 px-4 border-b border-white/5 bg-red-500/5">
          ...
          {/* Ad Banner */}
          <AdBanner variant="inline" showClose={false} page="league-overview" />
