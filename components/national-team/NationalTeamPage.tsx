// components/national-team/NationalTeamPage.tsx
"use client";
...
function NationalTeamPageContent({ leagueId }: { leagueId: string }) {
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-4">
            Error loading National Team data
          </h2>
      ...
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          ...
          <p className="text-zinc-400 mb-6">
            The National Team data is currently unavailable.
          </p>
            ...
            <CardContent className="p-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-zinc-800/30 rounded-lg p-3 border border-white/5">
                  ...
                  <p className="text-white font-medium">{league?.category || "National Team"}</p>
                </div>
                <div className="bg-zinc-800/30 rounded-lg p-3 border border-white/5">
...
export default function NationalTeamPage({ leagueId }: { leagueId: string }) {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
    ...
    >
      <NationalTeamPageContent leagueId={leagueId} />
    </Suspense>
  );
}