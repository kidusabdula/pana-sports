        ...
        <Card className="bg-zinc-800/20 backdrop-blur-sm border-zinc-700/30">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-semibold">Round of 12</p>
            </div>
        ...
        <Card className="bg-zinc-800/20 backdrop-blur-sm border-zinc-700/30">
          <CardContent className="p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-lg font-semibold">Bahir Dar Kenema</p>
            </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="teams" className="mt-6">
          <div className="text-center text-muted-foreground py-8">
            ...
            <p className="text-lg">Current Round: Round of 12</p>
            <p className="text-lg mb-4">Defending Champion: Bahir Dar Kenema</p>
          </div>
        </TabsContent>
