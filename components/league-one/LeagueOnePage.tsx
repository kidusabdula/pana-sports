// components/league-one/LeagueOnePage.tsx
"use client";
...
function LeagueOnePageContent({ leagueId }: { leagueId: string }) {
  ...
  if (!league) {
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8 max-w-md mx-auto text-center">
          <h2 className="text-2xl font-bold text-white mb-4">
            League One Not Found
          </h2>
          <p className="text-zinc-400 mb-6">
            The League One data is currently unavailable.
          </p>
...
export default function LeagueOnePage({ leagueId }: { leagueId: string }) {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
    ...
    >
      <LeagueOnePageContent leagueId={leagueId} />
    </Suspense>
  );
}
