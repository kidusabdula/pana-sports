...
-- Add new column for large banner image
ALTER TABLE public.ad_images 
...
-- Make the original image_url column nullable
-- This is NECESSARY because the new API only sends image_url_large and image_url_small
-- and would otherwise fail with a NOT NULL constraint violation.
ALTER TABLE public.ad_images 
...
COMMENT ON COLUMN public.ad_images.image_url IS 'Deprecated legacy field. Use image_url_large instead.';
